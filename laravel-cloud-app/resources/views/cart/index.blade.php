...
@section('content')
    ...
    @if (session('success'))
        <div class=" d-inline-block box mx-auto p-4 bg-success border border-green-500 rounded-lg mb-5 "> 
                <p class="text-bold text-green-500 text-center"> {{ session('success') }} </p>
        </div>
    @endif
                        ...
                        @if (session('cartItems'))
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr>
                                        ...
                                        <td class="px-6 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('delete-add-to-cart', $key)  }}" role="button"
                            ...
                            @else
                                <td align="left" colspan="3">
                                    <p class="font-bold text-l text-black-50 py-6 px-4 ">
